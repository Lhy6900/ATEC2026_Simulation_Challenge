...
# Verified from scripts/play_atec_task.py at Elapsed_Time=9.50s. The box is
# stationary in the pit and the robot is on the near ground edge, before hard policy handoff.
COUNTER950_ROBOT_POSE = (
    3.4137089252471924,
    -1.5012480020523071,
    0.6975134611129761,
    0.9921770691871643,
...
COUNTER950_BOX_SUPPORT_POSE = (
    4.36343640089035,
    -0.7996934652328491,
    -0.5999999642372131,
    0.7071065902709961,
    -1.4027000361238606e-05,
    0.70710688829422,
    1.3851278708898462e-05,
)
COUNTER950_ROBOT_ROOT_VELOCITY = (
    0.25904640555381775,
    -0.4047621786594391,
    0.09794872254133224,
    0.8786299228668213,
...
CROSS_PIT_START_X = 3.4137089252471924
CROSS_PIT_DOWN_STEP_X = 3.72
CROSS_PIT_BOX_X = 4.36343640089035
CROSS_PIT_TARGET_Y = -0.7996934652328491
CROSS_PIT_BOX_FRONT_X = 4.0634
CROSS_PIT_BOX_BACK_X = 4.6635
CROSS_PIT_BOX_TOP_Z = -0.20
CROSS_PIT_BOX_STAGE_TARGET_X = 4.36343640089035
CROSS_PIT_NEAR_BOX_GAP_X = 0.34
CROSS_PIT_FAR_LIP_X = 4.68
CROSS_PIT_PLATFORM_X = 5.10
CROSS_PIT_SUCCESS_START_X = 3.72
CROSS_PIT_SUCCESS_FINAL_X = 7.80
CROSS_PIT_MIN_X = 2.6637089252471924
CROSS_PIT_BOX_GRID_SHAPE = (24, 16)

COUNTER950_JOINT_POS = {
    'left_hip_pitch_joint': -0.45682671666145325,
    'right_hip_pitch_joint': -0.5572284460067749,
    'waist_yaw_joint': 0.20661497116088867,
    'left_hip_roll_joint': -0.08962488174438477,
    'right_hip_roll_joint': 0.028130685910582542,
    'waist_roll_joint': 0.08852449059486389,
    'left_hip_yaw_joint': -0.0881255567073822,
    'right_hip_yaw_joint': 0.04053123667836189,
    'waist_pitch_joint': 0.062082525342702866,
    'left_knee_joint': 1.0985935926437378,
    'right_knee_joint': 1.3768079280853271,
    'left_shoulder_pitch_joint': 0.3285810351371765,
    'right_shoulder_pitch_joint': 0.3385468125343323,
    'left_ankle_pitch_joint': -0.3756987154483795,
    'right_ankle_pitch_joint': -0.7433120608329773,
    'left_shoulder_roll_joint': 0.1655479520559311,
    'right_shoulder_roll_joint': -0.16888713836669922,
    'left_ankle_roll_joint': -0.0048864237032830715,
    'right_ankle_roll_joint': 0.018568988889455795,
    'left_shoulder_yaw_joint': -0.007389130536466837,
    'right_shoulder_yaw_joint': 0.006533315405249596,
    'left_elbow_joint': 0.871192991733551,
    'right_elbow_joint': 0.874342679977417,
    'left_wrist_roll_joint': -5.947055797150824e-06,
    'right_wrist_roll_joint': -5.401173257268965e-05,
    'left_wrist_pitch_joint': 0.0015294573968276381,
    'right_wrist_pitch_joint': 0.0013727437471970916,
    'left_wrist_yaw_joint': -0.0016873403219506145,
    'right_wrist_yaw_joint': 0.0008592043304815888,
    'left_hand_Joint1_1': 0.024016039445996284,
    'left_hand_Joint2_1': 0.024009937420487404,
    'right_hand_Joint1_1': 0.0239851213991642,
    'right_hand_Joint2_1': 0.024070018902420998,
}

COUNTER950_JOINT_VEL = {
    'left_hip_pitch_joint': 1.540778636932373,
    'right_hip_pitch_joint': -1.656969428062439,
    'waist_yaw_joint': -0.5048523545265198,
    'left_hip_roll_joint': -1.1917492151260376,
    'right_hip_roll_joint': -1.93829345703125,
    'waist_roll_joint': -0.7419863343238831,
    'left_hip_yaw_joint': -0.5080357789993286,
    'right_hip_yaw_joint': 1.407650351524353,
    'waist_pitch_joint': -0.22085493803024292,
    'left_knee_joint': -0.597152829170227,
    'right_knee_joint': -4.717284679412842,
    'left_shoulder_pitch_joint': 0.1392972767353058,
    'right_shoulder_pitch_joint': 0.35681435465812683,
    'left_ankle_pitch_joint': 0.7002562284469604,
    'right_ankle_pitch_joint': 3.7889597415924072,
    'left_shoulder_roll_joint': 0.21920320391654968,
    'right_shoulder_roll_joint': -0.07396063208580017,
    'left_ankle_roll_joint': -0.8888468742370605,
    'right_ankle_roll_joint': 0.9245628118515015,
    'left_shoulder_yaw_joint': 0.03813411667943001,
    'right_shoulder_yaw_joint': -0.07004520297050476,
    'left_elbow_joint': -0.12994326651096344,
    'right_elbow_joint': 0.14556576311588287,
    'left_wrist_roll_joint': 0.0006816587992943823,
    'right_wrist_roll_joint': 0.0009778726380318403,
    'left_wrist_pitch_joint': -0.05825795605778694,
    'right_wrist_pitch_joint': 0.038854628801345825,
    'left_wrist_yaw_joint': 0.0041898032650351524,
    'right_wrist_yaw_joint': -0.008707483299076557,
    'left_hand_Joint1_1': 5.252276605460793e-05,
    'left_hand_Joint2_1': 0.0002274103171657771,
    'right_hand_Joint1_1': 4.840191104449332e-05,
    'right_hand_Joint2_1': -1.7287646187469363e-05,
}

COUNTER950_LAST_ACTION = (
    -0.5318777561187744,
    0.06515301764011383,
    -0.2943190634250641,
    1.0854837894439697,
...
def _build_counter950_terrain_cfg() -> TerrainImporterCfg:
...
class CrossPitBoxSceneCfg(InteractiveSceneCfg):
    """Fixed counter-950 scene: 9.5s TaskD handoff with the box already in the pit."""

    terrain = _build_counter950_terrain_cfg()
    ...
    box_support = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(
            pos=COUNTER950_BOX_SUPPORT_POSE[:3],
            rot=_pose_quat(COUNTER950_BOX_SUPPORT_POSE),
        ),
    )
...
class ObservationsCfg:
    ...
    class CriticCfg(ObsGroup):
        ...
        box_center_lateral_error = ObsTerm(
            ...
            params={"box_y": COUNTER950_BOX_SUPPORT_POSE[1]},
            clip=(-100.0, 100.0),
        )
...
class EventsCfg:
    reset_box_support = EventTerm(
        ...
        mode="reset",
        params={
            "pose": COUNTER950_BOX_SUPPORT_POSE,
            "pose_noise": {},
        },
    )
    reset_robot = EventTerm(
        ...
        mode="reset",
        params={
            "pose": COUNTER950_ROBOT_POSE,
            "pose_noise": {"x": (-0.10, 0.10), "y": (-0.12, 0.12), "yaw": (-0.2617993877991494, 0.2617993877991494)},
            "velocity_noise": {
                "x": (-0.10, 0.10),
                "y": (-0.05, 0.05),
                "z": (0.0, 0.0),
            ...
            "root_velocity": COUNTER950_ROBOT_ROOT_VELOCITY,
            "joint_pos_overrides": COUNTER950_JOINT_POS,
            "joint_pos_noise": 0.06,
            "joint_vel_overrides": COUNTER950_JOINT_VEL,
            "last_action": COUNTER950_LAST_ACTION,
        },
    )
...
class RewardsCfg:
    ...
    forward_velocity = RewTerm(
        ...
        weight=2.0,
        params={"max_velocity": 1.0, "min_height": 0.30, "max_abs_gravity_xy": 0.75},
    )
    ...
    stage_stall = RewTerm(
        ...
        weight=-5.0,
        params={
            "stage_start_x": CROSS_PIT_BOX_STAGE_TARGET_X,
            "target_y": CROSS_PIT_TARGET_Y,
            "success_x": CROSS_PIT_SUCCESS_START_X,
            "success_x_attr": "cross_pit_success_x",
            "unlock_success_x": CROSS_PIT_BOX_STAGE_TARGET_X,
...
class CurriculumCfg:
    success_x = CurrTerm(
        ...
        params={
            ...
            "report_relative_to_x": CROSS_PIT_DOWN_STEP_X,
            "ema_alpha": 0.2,
        },
    )
...
@configclass
class CrossPitBoxG1V2EnvCfg(ManagerBasedRLEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.robot = UNITREE_G1_29DOF_DEX1_CFG.replace(
            ...
            init_state=UNITREE_G1_29DOF_DEX1_CFG.init_state.replace(
                pos=COUNTER950_ROBOT_POSE[:3],
                rot=_pose_quat(COUNTER950_ROBOT_POSE),
                joint_pos=COUNTER950_JOINT_POS,
            ),
        )
