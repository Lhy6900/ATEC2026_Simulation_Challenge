...
export TASK_NAME="${TASK_NAME:-ATEC-Isaac-TaskD-G1-CrossPitBox-v2}"
export RUN_NAME="${RUN_NAME:-cross_pit_box_v2_9p5s_mlp_pbrs_x_gpus_${DEFAULT_GPUS_LABEL}_env${DEFAULT_NUM_ENVS_PER_GPU}}"
